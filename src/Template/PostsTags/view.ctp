...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Posts Tag'), ['action' => 'edit', $postsTag->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Posts Tag'), ['action' => 'delete', $postsTag->id], ['confirm' => __('Are you sure you want to delete # {0}?', $postsTag->id)]) ?> </li>
...
<div class="postsTags view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $postsTag->has('tag') ? $this->Html->link($postsTag->tag->id, ['controller' => 'Tags', 'action' => 'view', $postsTag->tag->id]) : '' ?></td>
        </tr>
        <tr>
